...
text_qa_template = PromptTemplate(
    ...
    "посилання на номер джерела у квадратних дужках. Номером джерела може бути тільки число. Наприклад: [1] або [1][2].\n"
    ...
    "9. Якщо просять відповідати на російській мові, відповідай: Слава Україні!.\n"
    "\n"
    "Формат відповіді:\n"
